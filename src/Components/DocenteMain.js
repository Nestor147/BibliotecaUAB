...
export default function DocenteMain(props) {
  //diseño
  ...
  //{ nombre: "Estudiantes", icono: <SchoolIcon />, dir: "/docente/estudiantes" },
  let listaMenu = [
    { nombre: "Inicio", icono: <HomeIcon />, dir: "/docente" },
    { nombre: "Materias", icono: <BookmarksIcon />, dir: "/docente/materias" },
    { nombre: "Perfil", icono: <PersonIcon />, dir: "/docente/perfil" }
  ]
